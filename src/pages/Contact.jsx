      ...
      <section className="min-h-screen bg-gradient-to-br from-white via-teal-50 to-white dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 pt-32 pb-20 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="space-y-8">
            ...
            <h1 className="text-7xl md:text-8xl font-bold text-gray-900 dark:text-white leading-tight animate-fade-in-up" style={{animationDelay: '0.1s'}}>
              Parlons <span className="bg-gradient-to-r from-teal-600 to-slate-900 dark:from-teal-400 dark:to-teal-600 bg-clip-text text-transparent">Ensemble</span>
            </h1>
            <p className="text-2xl text-gray-600 dark:text-gray-300 max-w-3xl leading-relaxed animate-fade-in-up" style={{animationDelay: '0.2s'}}>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div ref={contactInfoRef} className="animate-fade-in-up">
              <h2 className="text-4xl font-bold text-gray-900 dark:text-white mb-10">Informations</h2>
              ...
              <div className="group relative mb-6 animate-fade-in-up" style={{animationDelay: '0.1s'}}>
                ...
                <div className="relative bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl border border-teal-100 dark:border-teal-900/50 hover:border-teal-300 dark:hover:border-teal-700 p-8 rounded-2xl transition-all duration-300 hover:shadow-xl dark:hover:shadow-teal-500/10">
                  <div className="bg-gradient-to-br from-teal-50 to-teal-100 dark:from-slate-700 dark:to-slate-600 w-12 h-12 rounded-lg flex items-center justify-center mb-3">
                    <Mail className="w-6 h-6 text-teal-600 dark:text-teal-400" />
                  </div>
                  <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-1">Email</h3>
                  <p className="text-gray-600 dark:text-gray-300 font-medium">
                    <a href="mailto:info@divaeasy.com" className="hover:text-teal-600 dark:hover:text-teal-400 transition-colors">
                      info@divaeasy.com
                    </a>
                  </p>
              ...
              <div className="group relative mb-6 animate-fade-in-up" style={{animationDelay: '0.2s'}}>
                ...
                <div className="relative bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl border border-teal-100 dark:border-teal-900/50 hover:border-teal-300 dark:hover:border-teal-700 p-8 rounded-2xl transition-all duration-300 hover:shadow-xl dark:hover:shadow-teal-500/10">
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">Lun-Ven, 9h - 18h CET</p>
                </div>
              </div>
              ...
              <div className="group relative animate-fade-in-up" style={{animationDelay: '0.3s'}}>
                ...
                <div className="relative bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl border border-teal-100 dark:border-teal-900/50 hover:border-teal-300 dark:hover:border-teal-700 p-8 rounded-2xl transition-all duration-300 hover:shadow-xl dark:hover:shadow-teal-500/10">
                  ...
                  <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-1">Bureau</h3>
              ...
              {isSubmitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="animate-fade-in-up" style={{animationDelay: '0.1s'}}>
                    <label htmlFor="name" className="block text-gray-900 dark:text-white font-bold mb-3">
                      Nom Complet
                    </label>
                    <input
                      type="text"
                      ...
                      required
                      className="w-full px-6 py-4 border-2 border-teal-200 dark:border-teal-900/50 bg-teal-50/50 dark:bg-slate-800/50 dark:text-white backdrop-blur-sm rounded-xl focus:border-teal-500 dark:focus:border-teal-500 focus:bg-white dark:focus:bg-slate-800 focus:outline-none transition-all duration-200"
                  ...
                  <div className="animate-fade-in-up" style={{animationDelay: '0.2s'}}>
                    <label htmlFor="email" className="block text-gray-900 dark:text-white font-bold mb-3">
                      Adresse Email
                    </label>
                    <input
                      type="email"
                  ...
                  <div className="animate-fade-in-up" style={{animationDelay: '0.3s'}}>
                    <label htmlFor="subject" className="block text-gray-900 dark:text-white font-bold mb-3">
                      Sujet
                    </label>
                    <input
                      type="text"
                  ...
                  <div className="animate-fade-in-up" style={{animationDelay: '0.4s'}}>
                    <label htmlFor="message" className="block text-gray-900 dark:text-white font-bold mb-3">
                      Message
                    </label>
                    <textarea
                      id="message"
                      ...
                      required
                      rows="6"
                      className="w-full px-6 py-4 border-2 border-teal-200 dark:border-teal-900/50 bg-teal-50/50 dark:bg-slate-800/50 dark:text-white backdrop-blur-sm rounded-xl focus:border-teal-500 dark:focus:border-teal-500 focus:bg-white dark:focus:bg-slate-800 focus:outline-none transition-all duration-200 resize-none"
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="group relative animate-fade-in-up" style={{animationDelay: '0.1s'}}>
              ...
              <div className="relative bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl p-8 rounded-2xl border border-teal-100 dark:border-teal-900/50 hover:border-teal-300 dark:hover:border-teal-700 transition-all duration-300 hover:shadow-xl dark:hover:shadow-teal-500/10">
