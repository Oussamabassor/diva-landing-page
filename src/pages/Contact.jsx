...
function Contact() {
  ...
  return (
    <div className="bg-white dark:bg-slate-950">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-white via-teal-50 to-white dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 pt-8 md:pt-16 pb-20">
