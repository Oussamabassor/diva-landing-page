    ...
    <footer className="bg-gradient-to-b from-white via-teal-50 to-slate-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-900 border-t border-teal-200/50 dark:border-teal-900/50 backdrop-blur-xl">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-lg font-bold text-gray-900 dark:text-white mb-6">Liens Rapides</h4>
            <ul className="space-y-3">
              <li>
                <Link to="/" className="text-gray-600 dark:text-gray-400 hover:text-teal-600 dark:hover:text-teal-400 transition-colors font-medium">
                  Accueil
                </Link>
              </li>
              <li>
                <Link to="/qui-sommes-nous" className="text-gray-600 dark:text-gray-400 hover:text-teal-600 dark:hover:text-teal-400 transition-colors font-medium">
                  Qui Sommes Nous
                </Link>
              </li>
              <li>
                <Link to="/contact" className="text-gray-600 dark:text-gray-400 hover:text-teal-600 dark:hover:text-teal-400 transition-colors font-medium">
                  Contact
                </Link>
              </li>
            </ul>
        ...
        {/* Bottom Bar */}
        <div className="border-t border-teal-200/50 dark:border-teal-900/50 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-600 dark:text-gray-400 text-sm font-medium">
              &copy; 2025 Diva Easy. Tous droits réservés.
            </p>
            <div className="flex gap-6 mt-6 md:mt-0">
              <a href="#" className="text-gray-600 dark:text-gray-400 hover:text-teal-600 dark:hover:text-teal-400 text-sm font-medium transition-colors">
